...
// import { buttonVariants } from "@/components/ui/button" // Assuming button variants exist, but standardizing styles inline to avoid issues
    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day_selected:
                    "bg-[#D2B48C] text-black hover:bg-[#C1A278] hover:text-black focus:bg-[#D2B48C] focus:text-black",
